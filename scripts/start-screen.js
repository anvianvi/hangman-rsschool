...
export function renderStartScreen() {
  ...
  welcomTextLine1.innerHTML =
    "We will think a word and then you should guess it letter by letter";

  const welcomTextLine2 = document.createElement("p");
  welcomTextLine2.innerHTML =
    "You will have 6 attempts to guess and then you lose. Good Luck!";
